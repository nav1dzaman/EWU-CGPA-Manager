...
function AddCourse({courselist,setCourseList,coursecode,setCourseCode,coursecredit,setCourseCredit,coursegrade,setCoursegrade}) {
  ...
  return (
    <div className="addtask ">
      <form onSubmit={handlesubmit}>
        ...
        <select className="border-2"  onChange={(e)=>{setCourseCredit(e.target.value)}} value={coursecredit}>
        ...
        <select className="border-2" onChange={(e)=>{setCoursegrade(e.target.value)}} value={coursegrade}>
        ...
        <span onClick={handlereset} className="bg-red-100 rounded-md p-2 ml-2 cursor-pointer" >Reset</span>
