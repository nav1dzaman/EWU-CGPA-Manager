...
function CourseCard({course,setCourseList,handledelete,handleedit}) {
  ...
  return (
    <div className="h-[114px] w-[200px] border-2 p-2 flex">
      ...
      <button onClick={()=>{handleedit(course.id)}} className="border-0 rounded-sm bg-green-400 p-1 cursor-pointer my-[16px]">Edit</button>
      </div>
    </div>
  );
}
